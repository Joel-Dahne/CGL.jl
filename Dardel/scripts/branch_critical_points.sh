...
#SBATCH --job-name branch_continuation
...
#SBATCH -o Dardel/logs/branch_continuation.o
#SBATCH -e Dardel/logs/branch_continuation.e
...
time julia --project=. Dardel/scripts/branch_critical_points.jl "$@"
