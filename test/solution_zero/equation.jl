@testset "solution_zero_equation" begin
    params = [
        (0.783077, 0.493223, 0.0, CGLParams(1, 1.0, 2.3, 0.0, 0.0)),
        (0.783077, 0.493223, 0.1, CGLParams(1, 1.0, 2.3, 0.1, 0.01)),
        (1.88576, 0.917383, 0.0, CGLParams(3, 1.0, 1.0, 0.0, 0.0)),
        (1.88576, 0.917383, 0.1, CGLParams(3, 1.0, 1.0, 0.1, 0.01)),
    ]
