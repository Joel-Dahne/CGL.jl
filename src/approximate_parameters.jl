"""
    approximate_parameters_simple_F(ξ₁::Float64, λ::CGLParams{Float64})
...
```
"""
function approximate_parameters_simple_F(ξ₁::Float64, λ::CGLParams{Float64})
    return (μ, κ) -> begin
...
"""
    approximate_parameters_simple(μ₀::T, κ₀::T, ξ₁::T, λ::CGLParams{T}) where {T}
...
```
"""
function approximate_parameters_simple(μ₀::T, κ₀::T, ξ₁::T, λ::CGLParams{T}) where {T}
...
"""
    approximate_parameters(μ₀::T, γ₀::Complex{T}, κ₀::T, ξ₁::T, λ::CGLParams{T}) where {T}
