function C_I_E(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    @assert (2λ.σ + 1) * v - 2 < 0
    return C.J_E / abs((2λ.σ + 1) * v - 2)
end

function C_I_P(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    @assert (2λ.σ + 1) * v - 2 / λ.σ + λ.d - 2 < 0
    return C.J_P / abs((2λ.σ + 1) * v - 2 / λ.σ + λ.d - 2)
end

function C_I_P_1_1(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    (; σ, d) = λ
...
function C_I_P_1_2(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    ...
    return abs(B_W(κ, λ) / 2c) * (2σ + 1) * C.P / abs((2σ + 1) * v - 2 / σ + d - 3)
end

function C_I_P_2_1(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    (; σ, d) = λ
    ...
    return abs(B_W(κ, λ) / 2c) * C.P
end

function C_I_P_2_2(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    (; σ, d) = λ
...
function C_I_P_2_3(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    (; σ, d) = λ
...
function C_I_P_2_4(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    (; σ, d) = λ
    ...
    return abs(B_W(κ, λ) / 4c^2) * (2σ + 1) * 2σ * C.P /
           abs((2λ.σ + 1) * v - 2 / λ.σ + λ.d - 4)
end

function C_I_P_2_5(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    (; σ, d) = λ
    ...
    return abs(B_W(κ, λ) / 4c^2) * (2σ + 1) * C.P / abs((2λ.σ + 1) * v - 2 / λ.σ + λ.d - 4)
end

function C_I_E_dξ(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    return C.J_E
end

function C_I_P_dξ(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    return C.J_P
end
...
function C_I_E_dϵ(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    return C.J_E_dϵ / abs((2λ.σ + 1) * v - 2)
end

function C_I_P_dϵ_1_1(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    _, _, c = _abc(κ, λ)

    return C.H / abs(2c)
end

function C_I_P_dϵ_1_2(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    (; d) = λ
...
function C_I_P_dϵ_1_3(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    (; σ, d) = λ
...
function C_I_P_dϵ_1_4(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    (; σ, d) = λ
...
function C_I_P_dϵ_1_5(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    (; σ, d) = λ
...
function C_I_P_dϵ_1_6(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    (; σ, d) = λ
...
function C_I_P_dϵ_1_7(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    (; σ, d) = λ
