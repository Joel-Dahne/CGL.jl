...
function C_u_dκ_2(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    ...
    return (
        ...
        C.E * (
            ...
            C_I_P_dκ_1_2(κ, ξ₁, v, λ, C) * ξ₁^-2 +
            C_I_P_dκ_1_3(κ, ξ₁, v, λ, C) * ξ₁^-2
        )
    ) * ξ₁^(2σ * v - 2)
end
...
function C_u_dκ_3(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    ...
    return (
        C.E_dκ * C_I_P_1_2(κ, ξ₁, v, λ, C) +
        C.E * (C_I_P_dκ_1_4(κ, ξ₁, v, λ, C) + C_I_P_dκ_1_5(κ, ξ₁, v, λ, C)) * ξ₁^-2
    ) * ξ₁^(2σ * v - 1)
end
...
function C_u_dκ_4(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    ...
    return C.E * C_I_P_dκ_1_6(κ, ξ₁, v, λ, C) * ξ₁^(2σ * v - 2)
end

function C_u_dκ_5(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    (; σ) = λ

    return C.E * C_I_P_dκ_1_7(κ, ξ₁, v, λ, C) * ξ₁^(2σ * v - 2)
end
...
function C_u_dξ_dκ_1(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    ...
    return (
        ...
        C.E_dκ * C.J_P +
        C.E_dξ * (C_I_P_dκ_1_1(κ, ξ₁, v, λ, C) + C_I_P_dκ_1_2(κ, ξ₁, v, λ, C)) +
        C.E * C.J_P_dκ
    ) * ξ₁^(2σ * v - 1)
end
...
function C_u_dξ_dκ_3(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    (; σ) = λ
    return (
        C.E_dξ_dκ * C_I_P_2_3(κ, ξ₁, v, λ, C) * ξ₁^-1 +
        C.E_dξ * (C_I_P_dκ_1_4(κ, ξ₁, v, λ, C) + C_I_P_dκ_1_5(κ, ξ₁, v, λ, C) * ξ₁^-1)
    ) * ξ₁^(2σ * v - 1)
end

function C_u_dξ_dκ_4(κ::Arb, ξ₁::Arb, v::Arb, λ::CGLParams{Arb}, C::FunctionBounds)
    (; σ) = λ
    return (C.E_dξ_dκ * C_I_P_2_4(κ, ξ₁, v, λ, C) + C.E_dξ * C_I_P_dκ_1_6(κ, ξ₁, v, λ, C)) *
           ξ₁^(2σ * v - 1)
end
